...
public class MaterialDialog {
	...
	public MaterialDialog setPositiveButton(int resId,
		...
		mPositiveButton.setBackgroundResource(R.drawable.dialog_button);
		mPositiveButton.setTextColor(Color.argb(255, 255, 87, 34));
	...
	public MaterialDialog setNegativeButton(int resId,
		...
		mNegativeButton.setBackgroundResource(R.drawable.dialog_button);
